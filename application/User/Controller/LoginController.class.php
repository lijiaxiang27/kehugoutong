...
class LoginController extends HomebaseController {
    ...
    public function __construct()
    {
        ...
        $config = [
            'debug'     => true,
            'app_id'    => 'wx79e8d65936431e22',
            'secret'    => '1368edf0d0d2e0aaa5745a88e19917c6',
            'token'     => 'zhang',
            'log' => [
                'level' => 'debug',
            ...
            'oauth' => [
                ...
                'callback' => '/index.php?g=user&m=login&a=cb',
            ],
            // ..
        ];
    ...
    public function wysq(){
        ...
        if (empty($_SESSION['wechat_user'])) {
            $_SESSION['target_url'] = '/index.php?g=user&m=login&a=wysq';
