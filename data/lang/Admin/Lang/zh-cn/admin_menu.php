...
return array (
  'ADMIN_ACT_ADD' => '活动添加',
  'ADMIN_ACT_ADD_POST' => '活动添加提交',
  'ADMIN_ACT_DELETE' => '活动删除',
  'ADMIN_ACT_EDIT' => '活动编辑',
  'ADMIN_ACT_EDIT_POST' => '活动编辑提交',
  'ADMIN_AD_ADD_POST' => '提交添加',
  'ADMIN_AD_EDIT_POST' => '提交编辑',
  'ADMIN_AD_TOGGLE' => '广告显示切换',
  'ADMIN_ADV_ADD' => '建议提交',
  'ADMIN_ADV_INDEX' => '建议列表',
  'ADMIN_BACKUP_DEFAULT' => '备份管理',
  'ADMIN_BACKUP_INDEX' => '数据备份',
  'ADMIN_BACKUP_INDEX_POST' => '提交数据备份',
  'ADMIN_BACKUP_RESTORE' => '数据还原',
  'ADMIN_COMPLAIN_ADD' => '投诉提交',
  'ADMIN_COMPLAIN_INDEX' => '投诉列表',
  'ADMIN_DESIGN_ADD' => '设计申请提交',
  'ADMIN_DESIGN_INDEX' => '设计申请',
  'ADMIN_DOWN_ADD' => '添加资料',
  'ADMIN_DOWN_ADD_POST' => '资料添加提交',
  'ADMIN_DOWN_DELETE' => '资料删除',
  'ADMIN_DOWN_EDIT' => '资料编辑',
  'ADMIN_DOWN_EDIT_POST' => '资料编辑提交',
  'ADMIN_DOWN_PX_INDEX' => '培训资料',
  'ADMIN_DOWN_QT_INDEX' => '其它资料',
  'ADMIN_DOWN_SC_INDEX' => '市场方案',
  'ADMIN_DOWN_YY_INDEX' => '运营资料',
  'ADMIN_ICON_INDEX' => '资料图标管理',
  'ADMIN_LECTURE_ADD' => '家庭教育申请提交',
  'ADMIN_LECTURE_INDEX' => '家庭讲座',
  ...
  'ADMIN_OTHERAPP_ADD' => '其他申请提交',
  'ADMIN_OTHERAPP_INDEX' => '其它申请',
  ...
  'ADMIN_SUPPORT_ADD' => '入校支持申请',
  'ADMIN_SUPPORT_INDEX' => '入校支持',
  'ADMIN_USER_ADD_POST' => '添加提交',
  'ADMIN_USER_BAN' => '禁用管理员',
  'ADMIN_USER_CANCELBAN' => '启用管理员',
  'ADMIN_USER_EDIT_POST' => '编辑提交',
  'ADMIN_USER_FRAMEWORK' => '组织架构',
  'ADMIN_USER_INDEX' => '所有用户',
  'ADMIN_USER_INDEX_GJ' => '高级经理',
  'ADMIN_USER_INDEX_JG' => '学管经理',
  'ADMIN_USER_INDEX_QY' => '区域经理',
  'ADMIN_USER_INDEX_SC' => '市场经理',
  'ADMIN_USER_INDEX_XZ' => '校区管理',
  'ADMIN_USER_INDEX_ZX' => '咨询经理',
  'ADMIN_USER_USERINFO' => '修改信息',
  'ADMIN_USER_USERINFO_POST' => '修改信息提交',
  'ADMIN_SETTING_CLEARCACHE' => '清除缓存',
  'ADMIN_SLIDE_DEFAULT' => '幻灯片',
  'ADMIN_AD_INDEX' => '网站广告',
  'ADMIN_DOWN_INDEX' => '资料下载',
  'ADMIN_LINK_INDEX' => '友情链接',
  'ADMIN_APPLY_DEFAULT' => '申请支持',
  'ADMIN_RECYCLE_DEFAULT' => '回收站',
  'ADMIN_OTHER_DEFAULT' => '投诉建议',
  'ADMIN_ACT_INDEX' => '活动列表',
