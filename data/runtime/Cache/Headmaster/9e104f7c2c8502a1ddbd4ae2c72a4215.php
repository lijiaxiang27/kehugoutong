...
document.body.style.height=document.documentElement.clientHeight+"px";
	...
	<div class="at-list">
		...
		<ul class="clear">
			...
			<li onclick="location='<?php echo leuu('Headmaster/Product/aotupad');?>'">
	...
	<div class="at-zxhd">
		<h3>最新活动</h3>
		<ul>
			<?php if(is_array($acts)): foreach($acts as $key=>$vo): if(strpos($vo['image'],'admin') !== false){ $tag = 1; } else { $tag = 0; } ?>
			<li  onclick="location='<?php echo U('Act/detail',array('id'=>$vo['id']));?>'" class="clear">
				<div class="zxhd-img">
					<?php if($tag == 1 ): ?><img src="<?php echo sp_get_image_preview_url($vo['image']);?>"  />
						<?php elseif($tag == 0 ): ?>
						<img src="<?php echo ($vo['image']); ?>"  /><?php endif; ?>
				</div>
				<div class="zxhd-cont">
