...
<body>
	<div class="wrap js-check-wrap">
		<ul class="nav nav-tabs">
			<li class="active"><a href="<?php echo U('user/index_xz',array('id'=>4));?>">校区列表</a></li>
			<li><a href="<?php echo U('user/add_xz');?>">添加校区</a></li>
		</ul>
        <form class="well form-search" method="post" action="<?php echo U('User/index_xz',array('id'=>4));?>">
            校区:
            ...
            <a class="btn btn-danger" href="<?php echo U('User/index_xz',array('id'=>4));?>">清空</a>
        </form>
			...
			<tbody>
				...
				<?php if(is_array($users)): foreach($users as $key=>$vo): ?><tr>
					...
					<td>
						...
						<?php else: ?>
							<a href='<?php echo U("user/edit_xz",array("id"=>$vo["id"]));?>'><?php echo L('EDIT');?></a> |
