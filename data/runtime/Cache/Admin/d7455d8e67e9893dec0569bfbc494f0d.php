...
<body>
	<div class="wrap js-check-wrap">
		<ul class="nav nav-tabs">
			<li class="active"><a href="<?php echo U('user/index_jg',array('id'=>3));?>"><?php echo L('ADMIN_USER_INDEX');?></a></li>
			<li><a href="<?php echo U('user/add_jg');?>">添加教管经理</a></li>
		</ul>
        <form class="well form-search" method="post" action="<?php echo U('User/index_jg',array('id'=>3));?>">
            校区:
            ...
            <a class="btn btn-danger" href="<?php echo U('User/index_jg',array('id'=>3));?>">清空</a>
        </form>
			...
			<tbody>
				...
				<?php if(is_array($users)): foreach($users as $key=>$vo): ?><tr>
					...
					<td>
						...
						<?php else: ?>
							<a href='<?php echo U("user/edit_jg",array("id"=>$vo["id"]));?>'><?php echo L('EDIT');?></a> |
